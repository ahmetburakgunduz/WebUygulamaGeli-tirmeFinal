    ...
    public class NhibernateHelper
    {
        ...
        private static ISessionFactory SessionFactory
        {
            get
            {
                if (_sessionFactory == null)
                {
                    ...
                    configuration.AddDeserializedMapping(mapping, "araba");
        ...
        public static Configuration ConfigureNhibernate()
        {
            ...
            configure.DataBaseIntegration(db =>
            {
                ...
                db.ConnectionString = "Data Source=DESKTOP-VTM5HRL\\SQLEXPRESS;Initial Catalog=araba;Integrated Security=True";
        ...
        protected static HbmMapping GetMappings()
        {
            ...
            mapper.AddMapping<Models.ArabaMap>();
            mapper.AddMapping<Models.AliciMap>();
